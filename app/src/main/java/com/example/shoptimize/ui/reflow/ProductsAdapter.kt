...
class ProductsAdapter(private val productos: List<Producto>) : RecyclerView.Adapter<ProductsAdapter.ProductViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        holder.image.setImageResource(producto.imagenResId)
    }
